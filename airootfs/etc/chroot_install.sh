...
pacman -S --noconfirm dhcpcd ebtables fakeroot sudo dnsmasq archiso libvirt virt-manager git curl wget alsa-utils netctl dialog wpa_supplicant polkit-gnome zsh go base-devel htop nfs-utils vi vim nitrogen neofetch rofi i3 xorg xorg-xinit qemu ovmf nvidia chromium steam <<< Y
